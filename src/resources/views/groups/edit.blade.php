...
<form action="{{ sprintf(url('/groups/%d/update'),$groups->group_id) }}" method="POST">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12">
            <div class="form-group{{ $errors->has('group_name') ? ' has-error' : '' }}">
              ...
              <input type="text" class="form-control" name="group_name" id="group_name" value="{{ old('group_name',$groups->group_name) }}">
          ...
          <div class="col-lg-6 col-md-12">
            <div class="form-group{{ $errors->has('administrator_name') ? ' has-error' : '' }}">
              ...
              <input type="text" class="form-control" name="administrator_name" id="administrator_name" value="{{ old('administrator_name',$groups->administrator_name) }}">
